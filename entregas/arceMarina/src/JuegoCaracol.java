...
public class JuegoCaracol {
    public static void main(String[] args) {
        ...
        final int PROFUNDIDAD_MAXIMA_CAIDA = 20;
        final int PROFUNDIDAD_MINIMA_CAIDA = 10;
        ...
        int profundidadCaracol = (int) (Math.random() * PROFUNDIDAD_MAXIMA_CAIDA - PROFUNDIDAD_MINIMA_CAIDA +1 )+PROFUNDIDAD_MINIMA_CAIDA;
        ...
        do{
            ...
            subidaCaracol = (int)(Math.random()*(4-1+1)+1);
            bajadaCaracol = (int)(Math.random()*(2-0+1)+0);
            ...
            profundidadCaracol = profundidadCaracol - subidaCaracol + bajadaCaracol + (aparcaCoche ? BAJADA_CARACOL_COCHE : 0);
