...
class CalculaNotaFinal {
    public static void main(String[] args) {
        ...
        double examenFinal, examenParcial, evaluaciónContinua, notaProfesor;
        ...
        evaluaciónContinua = scanner.nextDouble();
        ...
        final double EVALUACIÓN_CONTINUA_PONDERADO = 0.2;
        final double NOTA_PROFESOR_PONDERADO = 0.05;

        double notaFinal;

        notaFinal = examenFinal * EXAMEN_FINAL_PONDERADO + examenParcial * EXAMEN_PARCIAL_PONDERADO + evaluaciónContinua * EVALUACIÓN_CONTINUA_PONDERADO + notaProfesor * NOTA_PROFESOR_PONDERADO;
