...
class Marco {
        ...
        public static void main(String[] args) {
                ...
                do {
                        double velocidadBaseDeMarco = Math.random()
                                        * (VELOCIDAD_MEDIA__MAXIMA_DIARIO_DE_MARCO
                                                        - VELOCIDAD_MEDIA_MINIMA_DIARIA_DE_MARCO + 1)
                        ...
                        double velocidadMarco = velocidadBaseDeMarco
                        ...
                        double tiempoCaminadoBaseDeMarco = Math.random()
                                        * (TIEMPO_PROMEDIO_DIARIO_MAXIMO_DE_MARCO
                                                        - TIEMPO_PROMEDIO_DIARIO_MINIMO_DE_MARCO + 1)
                        ...
                        double velocidadBaseDeMadre = Math.random()
                                        * (VELOCIDAD_MEDIA__MAXIMA_DIARIO_DE_MADRE
                                                        - VELOCIDAD_MEDIA_MINIMA_DIARIA_DE_MADRE + 1)
                        ...
                        double velocidadMadre = velocidadBaseDeMadre
                        ...
                        double tiempoCaminadoBaseDeMadre = Math.random()
                                        * (TIEMPO_PROMEDIO_DIARIO_MAXIMO_DE_MADRE
                                                        - TIEMPO_PROMEDIO_DIARIO_MINIMO_DE_MADRE + 1)
