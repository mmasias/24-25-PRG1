class Marco {
        public static void main(String[] args) {
                ...
                do {
                        ...
                        boolean LloviendoFuerte = Math.random() >= PROBABILIDAD_LLUVIA_FUERTE;
                        boolean LloviendoNormal = Math.random() >= PROBABILIDAD_LLUVIA_NORMAL;
                        ...
                        double velocidadMarco = ((Math.random()
                                        ...
                                        * (LloviendoFuerte ? REDUCCION_VELOCIDAD_LLUVIA_FUERTE : 1)
                                        - (LloviendoNormal ? REDUCCION_VELOCIDAD_LLUVIA_NORMAL : 0)
                                        - (MonoEnBrazos ? REDUCCION_VELOCIDAD_MONO_EN_BRAZOS : 0);
                        ...
                        double tiempoCaminado = ((Math.random()
                                        * (TIEMPO_PROMEDIO_DIARIO_MAXIMO - TIEMPO_PROMEDIO_DIARIO_MINIMO + 1))
                                        ...
                                        - (MonoEscapa ? REDUCCION_TIEMPO_HORAS_MONO_ASCAPA : 0);
