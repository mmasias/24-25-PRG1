...
class MarcoExtension1y2 {
    ...
    public static void main(String[] args) {
        ...
        final double PROBABILIDAD_MARCO_ENCUENTRA_A_ALGUIEN_QUE_HA_VISTO_A_SU_MADRE = 0.5;
        final int AVANZADO_MARCO_ENCUENTRA_A_ALGUIEN_QUE_HA_VISTO_A_SU_MADRE = 25;
        ...
        final String TEXTO_MARCO_ENCUENTRA_A_ALGUIEN_QUE_HA_VISTO_A_SU_MADRE = "¡Un chico me ha dicho que ha visto a mi madre cerca!";
        ...
        do {
            ...
            boolean isMarcoEncuentraAAlguienQueHaVistoASuMadre = false;

            if (distancia < 50) {
                isMarcoEncuentraAAlguienQueHaVistoASuMadre = Math.random() >= PROBABILIDAD_MARCO_ENCUENTRA_A_ALGUIEN_QUE_HA_VISTO_A_SU_MADRE;
            }

            double distanciaRecorridaMarco
                    = velocidadMarco
                    * tiempoCaminadoMarco
                    + (isMarcoEncuentraAAlguienQueHaVistoASuMadre ? AVANZADO_MARCO_ENCUENTRA_A_ALGUIEN_QUE_HA_VISTO_A_SU_MADRE : 0);
            ...
            if (isMarcoEncuentraAAlguienQueHaVistoASuMadre) {
                System.out.println(TEXTO_MARCO_ENCUENTRA_A_ALGUIEN_QUE_HA_VISTO_A_SU_MADRE);
            }
