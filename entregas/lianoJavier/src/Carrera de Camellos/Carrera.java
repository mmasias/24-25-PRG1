...
class Carrera {
    ...
    public static final int RECORRIDO_TOTAL = 60;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            boolean jugadorAciertaEnElAgujero = aciertaEnElAgujero(seleccionJugador,
                    PROBABILIDAD_DE_ACIERTAR_EN_EL_AGUJERO);

            int avanceDelCamello = moverCamello(jugadorAciertaEnElAgujero, seleccionJugador,
                    AVANCE_DEL_CAMELLO_POR_ACERTAR_EN_EL_AGUJERO);
    ...
    public static void mostrarEstadoDelJuego(int avanceDelCamello, int posicionDelCamello, boolean camelloTropezo) {
        if (camelloTropezo) {
        ...
        System.out.println(
                (recorridoRestante == 0 ? COLOR_GREEN : COLOR_RED) + "Te quedan: " + recorridoRestante + COLOR_RESET);
    }
}
