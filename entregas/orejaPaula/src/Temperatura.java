...
class Temperatura {
    ...
    static double calcularMinima(double dia1, double dia2, double dia3, double dia4, double dia5, double dia6, double dia7) {
    ...
    static double calcularMaxima(double dia1, double dia2, double dia3, double dia4, double dia5, double dia6, double dia7) {
    ...
    static double calcularMedia(double dia1, double dia2, double dia3, double dia4, double dia5, double dia6, double dia7) {
        final int DIAS = 7;
        return (dia1 + dia2 + dia3 + dia4 + dia5 + dia6 + dia7) / DIAS;
    }

    static double pedirTemperatura() {
        System.out.println("Dígame la temperatura:");
