...
public class Adivinación {
    public static void main(String[] args) {
        ...
        int numeroIngresado = random.nextInt(100) + 1; 
        ...
        while (intentosRestantes > 0 && !haGanado) {
            ...
            int diferencia = Math.abs(numeroIngresado - numeroUsuario);

            if (numeroUsuario == numeroIngresado) {
                ...
                if (diferencia <= 5 && intentosRestantes <= 9) { 
                    numeroIngresado = ajustarNumeroPensado(numeroIngresado, random);
        ...
        if (!haGanado) {
            System.out.println("\nLo siento, se han agotado los intentos. El número era: " + numeroIngresado);
        }
