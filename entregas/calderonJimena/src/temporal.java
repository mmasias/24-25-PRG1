...
public class temporal {
    public static void main(String[] args) {
        ...
        final String POZO_SUPERIOR = "[_]              [_]";
        ...
        final double PROBABILIDAD_LLUVIA_MEDIA = 0.05;
        final double PROBABILIDAD_LLUVIA_FUERTE = 0.15;
        ...
        do {
            ...
            System.out.println("Dia [" + dia + "] - Subio[" + caracolSube + "] - Bajo[" + caracolBaja + "] - Posicion["
                    + profundidadCaracol + "]");
