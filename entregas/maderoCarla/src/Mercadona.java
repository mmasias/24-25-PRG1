public class Mercadona{
    public static void main(String[] args){
        ...
        for (int tiempoActual = 1; tiempoActual <= TIEMPO_TOTAL; tiempoActual++){
            ...
            minutosFilaVacia = minutosFilaVacia + ((unaFila==0 && llegaAlguien==0)?0:1);
        ...
        System.out.println("A l final de la jornada, la fila ha estado" + minutosFilaVacia+ " minutos vacia");
