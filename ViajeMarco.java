...
class ViajeMarco {
    public static void main(String[] args ){
        ...
        final double PROBABILIDAD_DE_LLUVIA_FUERTE = 0.1;
        final double PROBABILIDAD_DE_LLUVIA_NORMAL = 0.4;
        final double PROBABILIDAD_CHANGO_SE_ESCAPA = 0.15;
        final double PROBABILIDAD_CHANGO_SE_CANSA = 0.25;
        ...
        probabilidadLluvia = Math.random();
         ...
         if (probabilidadLluvia<=PROBABILIDAD_DE_LLUVIA_FUERTE){
            System.out.println("LLuvia fuerte");
            velocidadMarco = velocidadMarco*0.25;
         }else if (probabilidadLluvia<=PROBABILIDAD_DE_LLUVIA_NORMAL)  {
         ...
         if (probabilidadSeCansa <= PROBABILIDAD_CHANGO_SE_CANSA) {
        ...
        if (probabilidadSeEscapa <= PROBABILIDAD_CHANGO_SE_ESCAPA) {
